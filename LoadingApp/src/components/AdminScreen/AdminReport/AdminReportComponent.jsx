      ...
      <div className="flex flex-grow overflow-hidden">
        ...
        <main className="flex-grow p-6 overflow-auto">
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md space-y-4 p-6">
            ...
            <p className="text-gray-600">Velkommen til Admin rapporter siden. Genereres nå av komponenten.</p>
            <section className="space-y-4">
              <div className="p-4 bg-blue-50 rounded">
                <h3 className="text-xl font-semibold">Reports Overview</h3>
                <p className="text-gray-700">Her finner du en oversikt over alle genererte rapporter.</p>
              </div>
            </section>
          </div>
        </main>
